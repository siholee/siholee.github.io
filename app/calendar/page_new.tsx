          ...
          {selectedSchedules.length > 0 ? (
            <div className="space-y-3">
              {selectedSchedules.map((schedule) => (
                <div
                  key={schedule.id}
                  className="group flex items-center gap-x-4 rounded-xl bg-white dark:bg-gray-800 px-4 py-3 shadow-sm border border-gray-200 dark:border-gray-700"
                >
                  ...
                  <div className="flex space-x-2">
                    <button
                      ...
                      className="px-3 py-1 text-xs font-medium text-indigo-600 bg-indigo-50 rounded-full hover:bg-indigo-100 dark:text-indigo-400 dark:bg-indigo-900/50 dark:hover:bg-indigo-900"
                    >
                      상세보기
                    </button>
                    <button
                      onClick={() => handleCancelReservation(schedule.id)}
                      className="px-3 py-1 text-xs font-medium text-red-600 bg-red-50 rounded-full hover:bg-red-100 dark:text-red-400 dark:bg-red-900/50 dark:hover:bg-red-900"
                    >
                      취소
                    </button>
                  </div>
